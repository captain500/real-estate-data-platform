...
LISTINGS_REGISTRY: tuple[ColumnDef, ...] = (
    ...
    ColumnDef("move_in_date", SqlType.TEXT, hashed=True),
    # ── Property details ─────────────────────────────────────────────────
    ColumnDef("bedrooms", SqlType.INTEGER, hashed=True),
    ColumnDef("bathrooms", SqlType.INTEGER, hashed=True),
    ...
    # ── Amenities — Utilities ────────────────────────────────────────────
    ColumnDef("heat", SqlType.BOOLEAN, transform=Transform.TO_BOOLEAN, hashed=True),
    ColumnDef("water", SqlType.BOOLEAN, transform=Transform.TO_BOOLEAN, hashed=True),
    ColumnDef("hydro", SqlType.BOOLEAN, transform=Transform.TO_BOOLEAN, hashed=True),
    ...
    ColumnDef("laundry_in_unit", SqlType.BOOLEAN, transform=Transform.TO_BOOLEAN, hashed=True),
    ColumnDef("laundry_in_building", SqlType.BOOLEAN, transform=Transform.TO_BOOLEAN),
    ColumnDef("parking_included", SqlType.INTEGER, valid_range=NumericRange(min=0), hashed=True),
    # ── Amenities — Kitchen ──────────────────────────────────────────────
